...
function mainRepositoryRoot(root: string): string {
...
export function stateDirectory(root: string): string { return join(mainRepositoryRoot(resolve(root)), STATE_DIRECTORY_NAME); }
